...
## Memory that stays more up to date
...
## Lockdown Mode is now available to all logged-in users
...
Learn more: [Lockdown Mode](https://help.openai.com/en/articles/20001061)

## Rolling out ads in the UK
...
- [Appshots](https://developers.openai.com/codex/appshots) in the Codex app on macOS let you attach an app window to a Codex thread with a hotkey, including a screenshot and available text, so Codex can understand what you are looking at without a long setup prompt.
- [Goal mode](https://developers.openai.com/codex/prompting#goal-mode) is generally available across the Codex app, IDE extension, and CLI, so you can define an outcome and success criteria and let Codex keep working toward it.
...
- [Locked computer use](https://developers.openai.com/codex/app/computer-use#locked-use) lets eligible Mac Computer Use users keep Codex working remotely and securely after the Mac locks, subject to existing Computer Use regional constraints.
- [Browser use improvements](https://developers.openai.com/codex/app/browser) include advanced annotation mode, faster asset extraction, read-only JavaScript context, tab grouping usability, less Chrome extension tab clutter, and reliability improvements.

Learn more: [Appshots](https://developers.openai.com/codex/appshots), [Goal mode](https://developers.openai.com/codex/prompting#goal-mode), [locked computer use](https://developers.openai.com/codex/app/computer-use#locked-use), [in-app browser annotations](https://developers.openai.com/codex/app/browser#styling-feedback), and [config reference](https://developers.openai.com/codex/config-reference#requirementstoml).
...
Learn more in [Remote connections](https://developers.openai.com/codex/remote-connections).
...
- [**Free**](https://help.openai.com/en/articles/9275245-chatgpt-free-tier-faq)**:** 500 MB
- [**Go**](https://help.openai.com/en/articles/11989085-what-is-chatgpt-go)**:** 4 GB
- [**Plus**](https://help.openai.com/en/articles/6950777-what-is-chatgpt-plus) **and** [**Business**](https://help.openai.com/en/articles/8792828-what-is-chatgpt-business)**:** 20 GB
- [**Pro**](https://help.openai.com/en/articles/9793128-what-is-chatgpt-pro)**:** 100 GB
...
Library and ‘Recent files’ in the composer are supported on web, iOS, and Android. [Learn more](https://help.openai.com/en/articles/20001052-file-storage-and-library-in-chatgpt) about File storage and Library in ChatGPT.
...
For more information about this feature and eligibility requirements, see [Trusted contact in ChatGPT](https://help.openai.com/en/articles/20001105-trusted-contacts-in-chatgpt) and our [blog post](https://openai.com/index/introducing-trusted-contact-in-chatgpt/).
...
Install ChatGPT for Excel from Microsoft Marketplace or ChatGPT from Google Workspace Marketplace, then sign in with an eligible ChatGPT account. Review outputs before relying on formulas or analysis. [Learn more](https://help.openai.com/articles/20001063).
...
Learn more: [Advanced Account Security](https://help.openai.com/en/articles/20001221-advanced-account-security)
...
For more information, please see our help article [ChatGPT for Clinicians](https://help.openai.com/en/articles/20001046-chatgpt-for-healthcare) or our blog post [Making ChatGPT better for clinicians](https://openai.com/index/making-chatgpt-better-for-clinicians/).
...
To use this, connect the Outlook Email or Outlook Calendar app and provide the exact shared mailbox address or target calendar when asking ChatGPT. Availability may depend on your Microsoft permissions and workspace app settings. [Learn more](https://help.openai.com/en/articles/12512241).

## April 2, 2026

## ChatGPT in Apple CarPlay

We’re rolling out ChatGPT in CarPlay, giving you access to a hands-free ChatGPT experience while on-the-go. If you have iOS 26.4 or newer and are connected to a supported car, you can start new voice conversations with ChatGPT directly from the CarPlay interface. You can also resume existing conversations you were having using [voice mode](https://chatgpt.com/features/voice/) in the ChatGPT mobile app. [Learn more](https://help.openai.com/articles/20001153).

## March 27, 2026

## Updated Box, Notion, Linear, and Dropbox apps

We’re rolling out updated [Box](https://help.openai.com/en/articles/12368225-box-app-with-sync), [Notion](https://help.openai.com/en/articles/12532955-notion-app-with-sync), [Linear](https://help.openai.com/en/articles/12526595-linear-app-with-sync), and [Dropbox](https://help.openai.com/en/articles/12364275-dropbox-app-with-sync) apps in ChatGPT. These updates add new app actions, including new write capabilities where supported, and bring the latest app experience into ChatGPT.
...
For Pro users, Google Drive sync behavior is unchanged. [Read more](https://help.openai.com/en/articles/10408842-google-app-for-chatgpt-data-controls-faq).
...
Users can sign in with ChatGPT from the app and keep work moving across the app, CLI, and IDE without switching between tools for every task. Learn more: [Using Codex with your ChatGPT plan](https://help.openai.com/en/articles/11369540-using-codex-with-your-chatgpt-plan).
...
Learn more about [projects in ChatGPT](https://help.openai.com/en/articles/10169521-projects-in-chatgpt).
...
Get started by downloading the macOS app, and [learn more](https://help.openai.com/en/articles/11369540-using-codex-with-your-chatgpt-plan) about Codex.
...
Health appears as a new space in the ChatGPT sidebar. If you ask a health-related question in a regular chat, ChatGPT may also suggest continuing in Health. If you’re interested in getting access as it becomes available, you can sign up for the [waitlist](https://chatgpt.com/health/waitlist). We’re starting by providing access to a small group of early users to learn and continue refining the experience. At launch, Health is available on **web and iOS**, with Android coming soon to **ChatGPT Free, Go, Plus, and Pro users** in supported countries (excluding the EEA, Switzerland, and the UK).

Learn more in the [blog](https://openai.com/index/introducing-chatgpt-health/) or [help center article](https://help.openai.com/en/articles/20001036-what-is-chatgpt-health).
...
As part of this update, [**connectors now appear in the directory as apps**](https://help.openai.com/en/articles/11487775-apps-in-chatgpt), making it easier to manage all your tools in one place. References across the Help Center have been updated to reflect this new terminology.  
...
All images you create with ChatGPT are automatically saved under **My images** at [https://chatgpt.com/images](https://chatgpt.com/images), giving you a single place to browse, revisit, and reuse your work without having to sift through past conversations.

Learn more about ChatGPT Images in our [ChatGPT Images FAQ](https://help.openai.com/en/articles/11084440).
...
- Voice will continue to be available on [**chatgpt.com**](http://chatgpt.com/), iOS, Android, and Windows app.
...
Read our [blog](https://openai.com/index/introducing-gpt-5-2/) for more details on examples and evals.  
...
Shopping research is available on ChatGPT Web, iOS, and Android for logged‑in Free, Go, Plus, and Pro users. To help with holiday shopping, we’re making usage nearly unlimited across plans through the season. To learn more, visit the [blog](https://openai.com/index/chatgpt-shopping-research/).
...
Group chats are starting to roll out on ChatGPT Web, iOS, and Android in New Zealand, Japan, South Korea, and Taiwan. We’ll use early feedback from this pilot to improve the experience and inform how we expand to more regions and plans over time. To learn more visit the [blog](https://openai.com/index/group-chats-in-chatgpt/).
...
Eligible customers in India can get now get 12 months of [ChatGPT Go](https://what%20is%20chatgpt%20go/) at no cost. new New users can [redeem now](https://help.openai.com/en/articles/12739021-chatgpt-go-promotion-india) on ChatGPT web or the Android app (Google Play). The Apple App Store option arrives next week - no promo code is required for redemption.
...
If you have an existing ChatGPT Go membership, we may be able to automatically add the promotion for you at the end of your current billing cycle - review [ChatGPT Go Promotion (India)](https://help.openai.com/en/articles/12739021-chatgpt-go-promotion-india) for more details.  
...
We're excited to announce that ChatGPT Go, our low cost subscription plan, is now available in 8 additional countries in Europe, bringing total coverage to [**98 countries**](https://help.openai.com/en/articles/11989085-what-is-chatgpt-go#h_3dfe7afb4d). The new countries we added are Austria, Czech Republic, Denmark, Norway, Poland, Portugal, Spain and Sweden.

For an affordable price, ChatGPT Go provides everything included in the [Free](https://help.openai.com/en/articles/9275245-chatgpt-free-tier-faq) plan, and:
...
Learn more about [ChatGPT Go](https://help.openai.com/en/articles/11989085-what-is-chatgpt-go).
...
We're launching ChatGPT Go, our low cost subscription plan, in Brazil. ChatGPT Go provides everything included in the [Free](https://help.openai.com/en/articles/9275245-chatgpt-free-tier-faq) plan, and:
...
We’re updating the model for signed-out users to GPT-5 Instant, giving more people access to higher-quality responses by default. [See here](https://openai.com/index/introducing-gpt-5/) to learn more about the intelligence of GPT-5.
...
We're excited to announce that ChatGPT Go, our low cost subscription plan, is now available in [71 additional countries](https://help.openai.com/en/articles/11989085-what-is-chatgpt-go#h_3dfe7afb4d), bringing total coverage to **89 countries**.
...
We’re rolling out two new ways to bring Slack and ChatGPT together: a [connector](https://help.openai.com/en/articles/11487775-connectors-in-chatgpt) that brings your Slack context into ChatGPT, and a ChatGPT app for Slack – an integration that enables you to chat with ChatGPT from inside Slack.
...
We're adding [**Notion**](https://help.openai.com/en/articles/12532955-notion-synced-connector) and [**Linear**](https://help.openai.com/en/articles/12526595-linear-synced-connector) as synced connectors (for Pro users), so you can securely bring Notion pages and Linear issues/discussions into Chat for fast answers and summaries. You can enable sync for Notion and Linear from your Connector settings (connect to Notion or Linear if you haven’t already, first). Once synced, ChatGPT will automatically reference the indexed content when relevant. Learn more about [synced connectors](https://help.openai.com/en/articles/10847137-chatgpt-synced-connectors).

## October 8, 2025

## ChatGPT Go expansion

We're excited to announce that ChatGPT Go, our low cost subscription plan, is now available in [16 additional countries](https://help.openai.com/en/articles/11989085-what-is-chatgpt-go#h_3dfe7afb4d). For an affordable price, ChatGPT Go provides everything included in the [Free](https://help.openai.com/en/articles/9275245-chatgpt-free-tier-faq) plan, and:
...
We’re rolling out new Codex capabilities to help teams work and build better: [Codex now works in Slack](https://developers.openai.com/codex/integrations/slack), and supports programmatic control through the [Codex SDK](https://developers.openai.com/codex/sdk). Additionally, we've updated [Codex rates](https://help.openai.com/en/articles/11481834-chatgpt-rate-card#h_e8c3d8c100).

For more information, review our Help Center article on [Codex](https://help.openai.com/en/articles/11369540-using-codex-with-your-chatgpt-plan), and the [Codex developer documentation](https://developers.openai.com/codex).
...
You’re in control at all times and give explicit confirmation to purchase. Payment goes directly from you to the merchant, not through OpenAI. [Learn more about Instant Checkout](https://help.openai.com/en/articles/12440090-instant-checkout).
...
If you’re a merchant and want to add Instant Checkout in ChatGPT, apply on our [merchant page.](http://chatgpt.com/merchants) We’ll be accepting and onboarding merchants on a rolling basis.

Developers can start exploring the Agentic Commerce Protocol [documentation](https://developers.openai.com/commerce) and example implementations on [GitHub](https://github.com/agentic-commerce-protocol/agentic-commerce-protocol).
...
It requires saved memory and chat history to be turned on, and you can switch pulse off anytime in settings. See [ChatGPT Pulse](https://help.openai.com/en/articles/12293630-chatgpt-pulse).
...
For Rp 75.000/month, ChatGPT Go provides everything included in the [Free](https://help.openai.com/en/articles/9275245-chatgpt-free-tier-faq) plan, and:
...
To learn more about Codex, visit the [developers site](http://developers.openai.com/codex) as well as our general help article: [Using Codex with your ChatGPT plan](https://help.openai.com/en/articles/11369540).
...
An improvement to [projects](https://help.openai.com/en/articles/10169521-projects-in-chatgpt) is now available. When creating a project, users have the option to enable **project-only memory.**
...
Learn more about [memory in projects](https://help.openai.com/en/articles/10169521-projects-in-chatgpt#h_374a3efb05).
...
For ₹399/month (GST included), ChatGPT Go provides everything included in the [Free plan](https://help.openai.com/en/articles/9275245-chatgpt-free-tier-faq), and:
...
This update does not show an increase in sycophancy compared to the previous personality of GPT-5, measured by the same internal evals we ran and detailed in our [system card](https://cdn.openai.com/pdf/8124a3ce-ab78-4f06-96eb-49ea29ffb52f/gpt5-system-card-aug7.pdf). Teaching models to be warm without being sycophantic is an ongoing research challenge, and we will continue iterating to get this right. More updates are coming soon.
...
This was previously made available to Pro users on [August 12, 2025](#h_4da46a695f).

Learn more about [connectors](https://help.openai.com/en/articles/11487775-connectors-in-chatgpt).
...
[Learn more about study mode.](https://help.openai.com/en/articles/11780217)
...
Learn more about [connectors](https://help.openai.com/en/articles/11487775-connectors-in-chatgpt), as well as [how to create a custom connector using MCP](https://platform.openai.com/docs/mcp).

## July 17, 2025

## Updates to Advanced Voice Mode for Free tier users

The Advanced Voice upgrades [we announced on June 7th](#h_d1dfd7dad4) are now rolling out to ChatGPT free users too. With the same improvements available to paid users, ChatGPT sounds more natural and expressive, and can translate more effectively. Rate limits for free users stay the same.
...
Learn more about [record mode](https://help.openai.com/en/articles/11487532).
...
Learn more about [ChatGPT Record](https://help.openai.com/en/articles/11487532).
...
![Recommended Model setting with o3 selected as the default model](https://images.ctfassets.net/j22is2dtoxu1/intercom-img-42c382e8919222ca76fb3a1a/11e141f2c5d0a0d45437e44cf726bfdc/image.png)
...
[Learn more](https://help.openai.com/en/articles/10169521-using-projects-in-chatgpt) about projects.
...
![Chart of o3-pro win rate vs o3, with human testers preferring o3-pro across all query categories](https://images.ctfassets.net/j22is2dtoxu1/intercom-img-e5b17caf2d426949b0749916/bd6e50fc647b699b51a6dd84c2f81eb6/image.png)

Academic evaluations show that o3-pro consistently outperforms both o1-pro and o3.

![OpenAI o3-pro benchmark chart outperforming o1-pro and o3 (medium) on AIME 2024, GPQA Diamond, and Codeforces](https://images.ctfassets.net/j22is2dtoxu1/intercom-img-381dac8c40ab4bae4fbadb2f/ab87c7eae026218222dd1ec4d757d4bd/image.png)
...
![Benchmark chart where o3-pro leads o1-pro and o3 (medium) on AIME 2024, GPQA Diamond, and Codeforces](https://images.ctfassets.net/j22is2dtoxu1/intercom-img-bb477e0a041adca52db04dd5/ff20bc9bfde296996ecfa558b7519a2a/image.png)
...
Learn more about [Connectors in ChatGPT](https://help.openai.com/en/articles/11487775).
...
See: [Connect apps to ChatGPT deep research](https://help.openai.com/en/articles/11367239-connect-apps-to-chatgpt-deep-research)
...
See: [Connecting SharePoint and Microsoft OneDrive to ChatGPT deep research](https://help.openai.com/en/articles/11367239-connecting-sharepoint-and-microsoft-onedrive-to-chatgpt-deep-research)
...
See: [Connecting GitHub to ChatGPT deep research](https://help.openai.com/en/articles/11145903-connecting-github-to-chatgpt-deep-research).
...
See [**Memory FAQ**](https://help.openai.com/en/articles/8590148-memory-faq).
...
![ChatGPT mobile Ask anything composer with add, tools, microphone, and voice mode buttons](https://images.ctfassets.net/j22is2dtoxu1/intercom-img-5affc4bc052d8e7034e240fc/0a19be2b1c650cab5eaecd91143d9ab2/image__281_29.png)
...
![ChatGPT conversation with a failed response and Retry button](https://images.ctfassets.net/j22is2dtoxu1/intercom-img-3cdd73618024ab8950e30ac5/63ed4f5164447ba41afc7a326ed2adbf/AD_4nXdzDpE-gfBWvrTQ87epy-HFIBZldhIjPOvtbEoWmbMHDfT0CBojbDIc3uHIDouK1G5QLc17tafodtwwjozI9OyK56OY9YCh6FPmR3MzaayL19FbP34OlZnSM_4z)
...
![ChatGPT Projects conversation list with a draft reply being composed](https://images.ctfassets.net/j22is2dtoxu1/intercom-img-e234e8814f49a4f008de09da/9017a712fc65a125e63f6439bd312121/convo_drafts.gif)

4\. New UI for Temporary Chats: We’ve made accessing and viewing these private conversations more clear.

![ChatGPT Temporary Chat mode active, noting chats are not saved to history or memory](https://images.ctfassets.net/j22is2dtoxu1/intercom-img-d7c2ef7a8ad4833087c4481c/748154b0700350adf747066df56f8528/AD_4nXcagUHzhFAJ77sucpXjut4iqJGpQQgnecvFpczN2Z8pb7e8jj3iMRRAQ3VDBtO9whmiwlI7SrycQgB05V0YsGI8Uz6TEHE25VoE6j1-T3Oy16p2dwZU1FFlNGOu)

## Android App

1\. Increased the default size for in‐line generated images.

![Image](https://images.ctfassets.net/j22is2dtoxu1/intercom-img-e5efbee0ae42235cf5459bfd/308fcc2dec9e7b05cf9aa9ae7782ee82/AD_4nXdMb6umeD6hhe5C8CLCWVjjuovVrK2CvIc_pgDMOV14KWP2piNgaXSUPmO3EZ1Kh1V2vreRtSt77uH2Vw6pKsm18Ikw_1Loz53akTT7w6ObJ2F2xrpRRk9C1ls9)

2\. More clear and private Incognito keyboard for Temporary Chats.

![ChatGPT Android app Temporary chat screen with notice that chats are not saved to history or used to train models](https://images.ctfassets.net/j22is2dtoxu1/intercom-img-fb83fbf1e96cc973c83c0f86/b335948401867a75210802958bec9f6f/AD_4nXccArn8klVtK-yRYmHTRf2SAIxhtBeF7HOrqJJRYEPjSzY6_oKWXcKyOu_Mzm1hKgr3QemFA4irLzkqokWC6dYD4xNK8xBncOXBHbeuUfHDvb4c4SImBliYLuf2)

## iOS App

1\. Improved table-copying functionality out of ChatGPT responses on iOS and macOS.

![ChatGPT 4o research response with a grocery price table copied into Google Sheets](https://images.ctfassets.net/j22is2dtoxu1/intercom-img-af23d1c6c707122243cfa480/81e43efab6b2a56f5fe1cd38295f2bb2/AD_4nXdKLHEesAx8oF4R4LNwsIgftAV0zc_d72fTxfw_jms5REbzzBa7Qau2In4B2PDlbNl6L4S30pf_Y-7EdoElm6i3KmIeMrwhf03vZZ3L3l0YkgWQhwKVv13qtZyo)

2\. Added long press on your message to open menu actions: Copy, Edit.

![What’s new? prompt with a context menu offering Copy and Edit](https://images.ctfassets.net/j22is2dtoxu1/intercom-img-75cfda33f0afb2db20b05f32/04d5bc4e95fc686709b9c9302e308729/AD_4nXeVpORC8zTP-D3ctiYCgHwyW3cINg2DuLzYdAEt3VOK0VKvBAWJQ1lhpz0ThkfcgLNtmQjg1rdQ3LQspcFnrbeAYgZgHN2dTGoj3c7AtHvHLPyTcWkO4JEcJyTP)

3\. Improved response display of nested blockquote content.

![ChatGPT mobile chat with examples of Markdown blockquotes](https://images.ctfassets.net/j22is2dtoxu1/intercom-img-9d8031745ca40a3c54808a14/e42233b1a915797d327c475633a5600c/AD_4nXdx0xvUMu7k2329Y9KWsEzX-7r6dYFy7XuZFHETFnGWCLWWhPdFrDFzuALMTQwLjAmxpJuFUmSRYkTuG01qn-iJcV5MggMPqwuZs647yXrq4ey6t3xtxf8Ejv_d)

4\. Improved display and faster streaming of conversations and message menu actions.

![ChatGPT 4o mobile chat replying to “Hey what’s up”](https://images.ctfassets.net/j22is2dtoxu1/intercom-img-bc7baab448365e64b05009d1/299ebaaf1d5324bc9f65cc5df0f0ab46/AD_4nXd0p_mRlTA_FnrPiIV0jH_tzHwCId0GfaySOwJW1KcIPxdMybi8lQNl-QvFbfJE2zn0_tzugcvyqArLXeeuxgz05Yrid11hkGVzsRJF-aD4UQkfjjqriR_jgSMh)

## February 28, 2025

- General
	1. [GPT-4.5](https://help.openai.com/en/articles/10658365-gpt-4-5-in-chatgpt) was released to users on the Pro plan in ChatGPT.
...
- iOS
	1. **Long press to select** text on iOS and moved the message quick actions to always be visible below the message:
		1. ![ChatGPT iPhone app with selected reply text and the iOS text menu open](https://images.ctfassets.net/j22is2dtoxu1/intercom-img-6616c7acf1e6b07c4375fe8f/ce2f424d3d16f9bd81b314af2d33c8fb/image.png)
		2. Bug fixes and small improvements in the [1.2025.056 iOS release](https://apps.apple.com/us/app/chatgpt/id6448311069).
...
![iPhone ChatGPT widget with Message ChatGPT plus camera, photo, voice, and microphone shortcuts](https://images.ctfassets.net/j22is2dtoxu1/intercom-img-3c0dd58f7ad0ddc05ac5bbad/ad7b4c2a46951cfed269ea5d73c1e769/Screenshot_2025-02-25_at_4_24_03_E2_80_AFPM.png)
...
![Voice recording bar with transcript preview, waveform, and 0:02 duration](https://images.ctfassets.net/j22is2dtoxu1/intercom-img-15d48bb41027ab4c12d734b5/931c3379f4f4c7c245f3e33efbf01af7/image.png)
...
![Canvas preview titled Floaty Bubbles With Background with dot text reading SHARING NOW AVAILABLE](https://images.ctfassets.net/j22is2dtoxu1/intercom-img-85f12be24fda84bf8b196e42/0dce6e0340433d92a2b1e9dd089f698c/canvas-sharing-short.gif)
...
The new UI is rolling out now on [http://chatgpt.com](http://chatgpt.com/) and desktop on Windows, and is coming to mobile and desktop on MacOS in the next few weeks. Available soon to ChatGPT users in the EU, Norway, Iceland, Liechtenstein, and Switzerland.

![Image](https://images.ctfassets.net/j22is2dtoxu1/intercom-img-6556a8667ac6951f2f100fdd/e1dcf7b0aaf744620825d9ba615b9194/Custom_2BInstructions_2BUI.png)
...
![Santa theme card with snowy blue artwork and the subtitle Merry and bright](https://images.ctfassets.net/j22is2dtoxu1/intercom-img-cdaecdf9bcdaa1448f5b5674/2aa198a4a88b028374402cd7a3147b8b/AD_4nXc6Yrl0VAWKWtH0GECNN-FtImdMfgdYXUyrpLVWkA0wLQOlZZ1BnPAF_YhopSPdRZ7B6LwpvwgfoTUBzZXVl5_-L5WpBAYec6oVE4-0-XJ_PPUkx24m3LpAgUAy)
...
![Image](https://images.ctfassets.net/j22is2dtoxu1/intercom-img-1aecb5e619ee51a5b7b85f0e/88e779f0c9a39e87e2e38f0e0af6c173/AD_4nXd1o16dhWtMte7xA2AYZXivAghKAI-r-E0Fc60Lb2g6ftbsr9iIzOjshVrXQcTw5aJtZjWlqd1N3KZ91AvJraYi5TlSSX7xRN5ZXN4uN788H28C9TMPlJ4-sjMC)
...
![Capabilities list with Canvas selected and Web Search, DALL·E Image Generation, and Code Interpreter unchecked](https://images.ctfassets.net/j22is2dtoxu1/intercom-img-1f9186fb7887e515a6036855/537388c31b5e9fde5a90cec3bb45fb69/AD_4nXc2e7Kf7xmMuaOpFxDvhBrW7VSUCcqSiKmbTWAKl9rXr1yAwEYVe-OBPNVdyIzP9ya4EOM2-ORKGqLGa0ca0c_Xj3BokIFxivnkdWjG5ifss-gznx_93GTfuOd9)
...
![ChatGPT composer with the tools menu open, highlighting Picture for DALL·E](https://images.ctfassets.net/j22is2dtoxu1/intercom-img-8ae5b85edc783ff22ef6a4ef/324f2a5e22eab8f161700fa74c8c9ba5/AD_4nXf1UN0qvbHRoZi5V28X86BH614j43lPiYI9VFry3u0RU8oacZc9JyICW0qBzlZl4iUUiMITDsDHoO_fZJ_2N-8TWBsK_1_8YEYIaDEKpukBT8FgaS4KK6aEl4Po)
...
![ChatGPT Settings with Beta features selected and Web browsing and Plugins toggled on](https://images.ctfassets.net/j22is2dtoxu1/intercom-img-412da42b72c5b70efb883b5e/be57ea9e9471945856dd3e210ed2c80b/BetaPanel.png)
